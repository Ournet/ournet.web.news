...
module.exports = {
	...
	story: {
		name: 'stories_story',
		query: '(id:$id){id slug:uniqueName status host path summary createdAt countViews countNews imageId imageHost videos quotes title isImportant category topics{id slug:uniqueName name abbr type}}'
	},
	storyWebpages: {
		name: 'news_webpages',
		query: '(where:$where,country:$country,lang:$lang,limit:5,order:"-publishedAt"){id slug:uniqueName host path title imageId videoId createdAt publishedAt}'
	},
	topicStories: {
