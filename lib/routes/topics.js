...
//topic stories
route.get('/topic/:uniqueName/stories', function(req, res, next) {
  console.log('topic: ', req.params.uniqueName);
  var config = res.locals.config;
  var uniqueName = req.params.uniqueName.toLowerCase();
...
//topic quotes
route.get('/topic/:uniqueName/quotes', function(req, res, next) {
  var config = res.locals.config;
  var uniqueName = req.params.uniqueName.toLowerCase();
